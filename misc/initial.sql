...
CREATE TABLE `company` ( `id` int(11) NOT NULL auto_increment, `time`
  ...
  NOT NULL, `money` bigint(20) default NULL, `loan` bigint(20) default
  NULL, `value` bigint(20) default NULL, `trains` smallint(6) default
  NULL, `roadvs` smallint(6) default NULL, `planes` smallint(6)
  default NULL, `ships` smallint(6) default NULL, PRIMARY KEY (`id`),
  KEY `time` (`time`), KEY `company_id` (`company_id`);
